export const IconLoader = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='currentColor' {...props}>
      ...
      <circle transform-origin='center' stroke='currentColor' fill='none' stroke-width='15' stroke-linecap='round' stroke-dasharray='200 1000' stroke-dashoffset='0' cx='100' cy='100' r='70'>
